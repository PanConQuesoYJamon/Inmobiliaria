            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" id="impuesto" name="impuesto"
                           value="0.00" oninput="recalcularTotales()">
                </div>
    ...
    <div class="card" style="margin-bottom:20px;">
        ...
        <div class="table-wrapper">
            <table id="tabla-renglones">
                ...
                <tbody id="renglones-body">
                    <!-- Los renglones se agregan aquí -->
                </tbody>
                <tfoot>
                    <tr>
...
<!-- Datos de conceptos para JavaScript -->
<script>
...
// Agregar un renglón vacío al cargar
agregarRenglon();
</script>
